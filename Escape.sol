...
contract REDPILL is Ownable, IBEP20, SafeToken, LockToken {
    ...
    string constant _name = "Escape from the Matrix";
    string constant _symbol = "REDPILL";
    ...
    function setFees(uint256 _burnFee, uint256 _marketingFee, uint256 _feeDenominator) external onlyOwner {
        burnFee = _burnFee;
        marketingFee = _marketingFee;
        totalFee = _burnFee.add(_marketingFee);
